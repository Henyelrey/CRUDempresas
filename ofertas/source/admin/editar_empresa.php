...
// echo "se va a modificar" . $id_empresa;

//con el id recibido obtenemos los datos de dicha empresa de la base de datos 
//y los mostramos en un formulario para editar la informacion 
...
<form method="POST" action="actualizar_empresa.php">
    ...
    <!-- enviamos de forma oculta el id para hacer la modificacioin o actualizacion -->
